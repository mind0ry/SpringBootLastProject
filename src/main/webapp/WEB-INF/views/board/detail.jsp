                                    ...
                                    <li class="single_comment_area" v-for="(rvo,index) in list" :key="index">
                                        <div class="comment-wrapper d-flex">
                                            ...
                                            <div class="comment-content">
                                                ...
                                                <h5>{{rvo.name}}</h5>
                                                <p>{{rvo.msg}}</p>
                                                <a class="a-btn" v-if="sessionId===rvo.id" @click="toggleUpdate(rvo.no,rvo.msg)">{{upReplyNo===rvo.no?'취소':'수정'}}</a>
                                                <a class="active a-btn" v-if="sessionId===rvo.id" @click="replyDelete(rvo.no)">삭제</a>
                                                <div class="comment-form" style="padding-top:5px;"
                                                	v-if="upReplyNo===rvo.no"
                                                >
				                                    <form action="#" method="post" >
				                             
				                                            <textarea ref="msg" v-model="updateMsg[rvo.no]" cols="50" rows="4" placeholder="Message" style="float: left;display: inline-block;"></textarea>
                            ...
                            >
                                <div class="comment-form">
                                    ...
                                    <form action="#" method="post" >
                                            ...
                                            <textarea ref="msg" v-model="msg" cols="80" rows="4" placeholder="Message" style="float: left;display: inline-block;"></textarea>
